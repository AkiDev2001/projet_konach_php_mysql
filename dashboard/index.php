...
<html>
	<head>
		<title>Dashboard - Konach.ma</title>
	...
	<body>
		<div class="container">
			<div class="row">
                ...
                <div class="col-sm-10">
                	<h1 class="title text-center">Konach.ma</h1>
                    <div class="card">
	                        ...
	                        <div role="tabpanel" class="tab-pane active" id="home">	                        	
	                        	<div class="container">
	                        		<div class="row">
			                        	...
			                        	<div class="col-sm-5">
			                        		<h4 class="font">Welcome to your Konach.ma, <?php echo $_SESSION['First_Name'].' '.$_SESSION['Last_Name']; ?>!</h4>
